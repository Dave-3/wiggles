        ...
        <div class="welcome-area welcome-area-2 bg-color area-padding-2">
            <div class="container">
                <div class="row">
                    <div class="all-well-services">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="well-services">
                                <div class="well-img">
                                    <a class="big-icon" href="#"><i class="flaticon-006-chip"></i></a>
                                </div>
                                <div class="main-wel">
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="well-services">
                                <div class="well-img">
                                    <a class="big-icon" href="#"><i class="flaticon-109-report"></i></a>
                                </div>
                                <div class="main-wel">
                                    <div class="wel-content">
                                        <h4>Research & solution</h4>
                                        <p>Aspernatur sit adipisci quaerat unde at neque Redug Lagre dolor sit amet consectetu.</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="well-services">
                                <div class="well-img">
                                    <a class="big-icon" href="#"><i class="flaticon-130-web"></i></a>
                                </div>
                                <div class="main-wel">
                                    <div class="wel-content">
                                        <h4>Data science</h4>
                        ...
                        <div class="col-md-3 col-sm-6 col-xs-12">
                            <div class="well-services">
                                <div class="services-img">
                                    <a class="big-icon" href="#"><i class="flaticon-095-networking"></i></a>
                                </div>
                                <div class="main-wel">
                                    <div class="wel-content">
                ...
                <div class="row">
                   ...
                   <div class="col-md-6 col-sm-6 col-xs-12">
                        <div class="about-text">
                            <h3>About our <span class="color-2">Machine Learning</span> software firm.</h3>
       ...
       <!-- End Banner Area -->
					...
					<div class="all-service">
					    <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="single-service text-service">
                                <h3>Digital agency <span class="color-2">services & Solutions</span></h3>
                                <p>Our consultants opt in to the projects they genuinely want to work on.</p>
                                <a class="service-btn green-btn" href="#">All solution</a>
                            </div>
                        </div>
                        <!-- single-service end-->
                        <div class="col-md-4 col-sm-6 col-xs-12">
        ...
        <div class="achivement-area achivement-area-2 bg-color area-padding">
            <div class="container">
                <!-- Start counter Area -->
                <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
        ...
        <!-- End Subscribe area -->
        <!-- Start project Area -->
        <div class="project-area project-area-2 area-padding">
            <div class="container">
                <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 ">
						<div class="section-headline text-center">
        ...
        <!-- End project Area -->
        <!--Blog Area Start-->
        <div class="blog-area blog-area-2 bg-color area-padding-2">
            <div class="container">
                <div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12 ">
						<div class="section-headline text-center">
