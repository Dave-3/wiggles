   <!-- Start Bottom Header -->
        ...
        <div class="work-proses fix area-padding-3">
			<div class="container">
				<div class="row">
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="row">
                                    ...
                                    <div class="single-proses">
                                        <div class="proses-content">
                                            ...
                                            <div class="proses-text">
                                                <h4>Attention to details of your project</h4>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="single-proses">
                                        <div class="proses-content">
                                            ...
                                            <div class="proses-text">
                                                <h4>Building experts team for your requirement</h4>
                                                <p>We have a team of dedicated business development managers responsible for driving a pipeline of new business.</p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-4 col-sm-4 col-xs-12">
                                    <div class="single-proses last-item">
                                        <div class="proses-content">
                                            ...
                                            <div class="proses-text">
                                                <h4>Show result and on time delivery</h4>
                                                <p>We have a team of dedicated business development managers responsible for driving a pipeline of new business.</p>
                                            </div>
                                        </div>
                                    </div>
